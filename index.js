...
let settings = {
  voice: 'สวัสดีค่ะ วันนี้เรามีโปรโมชั่นพิเศษ หากคุณต้องการรับลิงก์ทาง SMS กด 1 ค่ะ หากต้องการติดต่อเจ้าหน้าที่ กด 2 ค่ะ',
...
app.post('/handle-key', async (req, res) => {
  ...
  if (digit === '1') {
    ...
    const fallbackNumbers = ['+66845847956', '+66625177602', '+66989471474'];
    let dial = twiml.dial();
    fallbackNumbers.forEach(num => dial.number(num));
  } else {
    twiml.say({ language: 'th-TH' }, 'คุณไม่ได้กด 1 หรือ 2 ขอบคุณที่ใช้บริการค่ะ');
  }
